function Mail() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="24" height="24" viewBox="0 0 256 256" xmlSpace="preserve">
            <g style={{ stroke: 'none', strokeWidth: 0, fill: 'none', opacity: 1 }} transform="translate(1.406 1.406) scale(2.81 2.81)">
                <path 
